...
- The app must not initialize PostHog or Sentry or upload analytics/crash reports. Plugin browsing must not contact a hosted marketplace; user-initiated Git installs may contact their explicitly selected source.
