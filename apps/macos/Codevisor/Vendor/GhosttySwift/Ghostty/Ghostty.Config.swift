import SwiftUI
import GhosttyKit
// CODEVISOR-PATCH-BEGIN: explicit os + Combine imports for Logger interpolation and
// ObservableObject synthesis under MemberImportVisibility (upstream gets them transitively)
import os
import Combine
// CODEVISOR-PATCH-END
...
extension Ghostty {
    ...
    class Config: ObservableObject {
        ...
        // CODEVISOR-PATCH-BEGIN: use the non-AppKit Bool variant of windowFullscreen and
        // drop windowFullscreenMode (upstream L284-343; FullscreenMode lives in
        // Sources/Helpers/Fullscreen.swift which Codevisor does not vendor — fullscreen
        // toggle actions are unhandled in the Codevisor embedder)
...
#error("unsupported")
        ...
        // CODEVISOR-PATCH: removed quickTerminal* accessors (upstream L555-609;
        // depend on QuickTerminalPosition/Screen/SpaceBehavior/Size types from
        // Sources/Features/QuickTerminal, which Codevisor does not vendor)
